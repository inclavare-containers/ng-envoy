...
void ExtensionRegistry::registerFactories() {
  ...
  // This is rats-tls certificate validator. Though it makes no sense to call this function,
  // since it is an empty function, we'll leave it here to maintain consistency with other
  // CertValidators.
  Extensions::TransportSockets::Tls::forceRegisterRatsTlsCertValidatorFactory();
